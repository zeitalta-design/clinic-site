...
export const metadata: Metadata = {
  ...
  description:
    "函館市美原の内科クリニックです。糖尿病・甲状腺疾患（内分泌内科）を専門に、地域のかかりつけ医として診療を行っています。院長 高橋清仁が丁寧な診察を心がけています。予約不要、駐車場完備。",
  keywords: [
    "内科高橋清仁クリニック",
    "函館市",
    "美原",
  ...
  twitter: {
    ...
    title: "函館市美原の内科｜糖尿病・甲状腺なら内科高橋清仁クリニック",
    description:
      "函館市美原の内科クリニックです。糖尿病・甲状腺疾患を専門に、地域のかかりつけ医として診療を行っています。予約不要、駐車場完備。",
