...
export const metadata: Metadata = {
  ...
  description:
    "函館市美原にある内科高橋清仁クリニックの紹介。糖尿病・甲状腺疾患を専門に、日本糖尿病学会専門医・日本内分泌学会専門医が在籍。駐車場18台完備、予約不要の通いやすい地域のかかりつけ医です。",
  keywords: [
    "内科高橋清仁クリニック 紹介",
    "函館市美原 内科",
    "函館 糖尿病 クリニック",
  ...
  openGraph: {
    title: "クリニック紹介｜函館市美原の内科高橋清仁クリニック",
    description:
      "糖尿病・甲状腺疾患を専門に、日本糖尿病学会専門医・日本内分泌学会専門医が在籍。駐車場18台、火曜は19:30まで夜間診療、予約不要。",
  ...
  twitter: {
    ...
    title: "クリニック紹介｜函館市美原の内科高橋清仁クリニック",
    description:
      "糖尿病・甲状腺専門医が在籍。駐車場18台・夜間診療・予約不要の地域のかかりつけ医。",
